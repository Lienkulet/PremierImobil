        ...
        <div className="flex flex-col md:flex-row gap-20 items-center">
            ...
            <div className="md:mt-32 mt-6 flex flex-col text-center md:text-start justify-center md:items-start items-center  gap-12">
                <div className="flex flex-row items-center gap-2">
                    <h3 className="md:text-5xl text-2xl text-white font-bold">Bun venit la <span className="text-mainOrange text-2xl md:text-5xl font-bold">PremierImobil</span> </h3>
                </div>
